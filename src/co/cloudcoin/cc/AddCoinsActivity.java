...
//		t2.setVisibility(View.GONE);
		...
		String importDir = bank.getImportDirPath();
		if (importDir == null) {
		...
		if (totalIncomeLength == 0) {
			mainText.setText("There were no CloudCoins found in your income folder. Please put your CloudCoins (.jpg or .stack) files in your income folder and try again. Your Income folder can be found at:\n\n" + importDir); 
			return;
		}

		mainText.setText("Import will import all CloudCoin files from your Import folder. Please put all your CloudCoin files (.jpg and .stack) into the Import folder located at:\n\n" + importDir + "\n\nWe are going to import " + Integer.toString(totalIncomeLength) + " files. Tap OK to continue");
